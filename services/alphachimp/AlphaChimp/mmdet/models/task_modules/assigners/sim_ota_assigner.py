...
class SimOTAAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        # Modified for ChimpDet, Original:
        # gt_labels = gt_instances.labels
        gt_labels = torch.zeros(size=(gt_instances.labels.size(0), ), dtype=torch.int64, device=gt_instances.labels.device)
        ...
        #print(F.one_hot(gt_labels.to(torch.int64),
        #          pred_scores.shape[-1]).float().unsqueeze(0).size())
        #print(num_valid.)
        gt_onehot_label = (
