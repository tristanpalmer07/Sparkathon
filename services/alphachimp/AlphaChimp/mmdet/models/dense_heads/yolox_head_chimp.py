...
class YOLOXHeadChimp(BaseDenseHead):
    ...
    def init_weights(self) -> None:
        ...
        super(YOLOXHeadChimp, self).init_weights()
    ...
    def predict_by_feat(self,
        ...
        for img_id, img_meta in enumerate(batch_img_metas):
            ...
            # print(flatten_objectness[img_id] * max_scores)
    ...
    def loss_by_feat(
        ...
        if num_pos > 0:
            ...
            # print('BBOX Pred', flatten_bboxes.view(-1, 4)[pos_masks])
            # print('BBOX Label', bbox_targets)
        else:
    ...
    def _get_targets_single(
        ...
        # print('BBOX TARGET', gt_instances)
