...
from .x3d import X3D
from .chimp_model import ChimpModel, ChimpModelAVG
from .chimp_modelv2 import ChimpModelV2
from .chimp_modelv3 import ChimpModelV3
from .resnet3d_chimp import Resnet3DChimp
...
__all__ = [
    ...
    'RGBPoseConv3D', 'ChimpModel', 'ChimpModelAVG', 'Resnet3DChimp', 'ChimpModelV2', 'ChimpModelV3'
]