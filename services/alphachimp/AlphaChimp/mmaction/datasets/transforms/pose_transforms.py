...
@TRANSFORMS.register_module()
class PreNormalize2DBBOX(BaseTransform):
    ...
    def transform(self, results: Dict) -> Dict:
        ...
        """
        bbox = results['bbox']
        w = results['bbox'][...,2]-results['bbox'][...,0]
        h = results['bbox'][...,3]-results['bbox'][...,1]
        w = w[...,np.newaxis]
        h = h[...,np.newaxis]
        results['keypoint'][..., 0] = \
...
class PoseDecode(BaseTransform):
    ...
    def transform(self, results: Dict) -> Dict:
        ...
        print(results['keypoint_score'].shape,results['keypoint'].shape,frame_inds)
        if 'keypoint_score' in results:
