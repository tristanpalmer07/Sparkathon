...
class LeipzigChimpActionDataset(BaseActionDataset):
    ...
    def get_data_info(self, idx: int) -> dict:
        ...
        data_info['filename_tmpl'] = data_info['video_id'] +'_'+self.filename_tmpl
        ...
        if self.proposals is not None:
            if img_key not in self.proposals:
                ...
                proposals = np.array(self.proposals[img_key])
